...
### 依頼事をアプリに投稿することで助けてもらう人とマッチさせて助けてもらう。
   ...
   #### 投稿者側(依頼者)
    ...
    - 6.チャット機能で指定場所等を教える。
    - 7.応募者に指定場所まで来てもらう。
    - 8.応募者に作業開始ボタン押下してもらう。(ステータスを応募者決定→作業中に変わる)
    - 9.応募者に依頼事を手伝ってもらう。
   ...
   #### 応募者側(受注者)
    ...
    - 7.作業開始ボタン押下(ステータスを応募者決定→作業中に変わる)
    - 8.依頼を手伝う。
    - 9.報酬をもらう。
...
#### 依頼事詳細画面
    ...
    - キャンセルボタン(ステータスが応募者決定時のみ表示)
      -　押下　→ ステータスが募集中に変わる。 
    - 作業開始ボタン押下(ステータスを応募者決定→作業中に変わる)
    - 完了ボタン(ステータスが作業中時、依頼者側のみ表示)
